...
void AboutMenu::Draw(SDL_Renderer* rR) {
	CCFG::getText()->DrawWS(rR, "MARIO - C++ AND MMM", 150, 128, 0, 0, 0);
	CCFG::getText()->DrawWS(rR, "DEVELOPER : ABDFNX", 150, 146, 0, 0, 0);

	CCFG::getText()->DrawWS(rR, "ABDFNX - 2020", 150, 224, 0, 0, 0);

	//CCFG::getText()->DrawWS(rR, "ABDFNX", 150, 264, 0, 0, 0);
